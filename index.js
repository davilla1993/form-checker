...
const pseudoChecker = (value) => {
    ...
    if(value.length > 0 && (value.length < 3 || value.length > 20)) {
        ...
        errorDisplay("pseudo", "Le pseudo doit être compris entre 3 et 20 caractères.");
        pseudo = null;
...
form.addEventListener('submit', (e)=> {
    ...
    if(pseudo && email && password && confirmPass) {
        ...
        pseudo = email = password = confirmPass = null;

        alert("Succès! Merci pour votre inscription.");

    } else {
        alert("Veuillez remplir tous les chmaps du formulaire");
    }
});